...
def genetic_algorithm(population_size, vector_length, max_calls_to_target_functions, tournament=False, elitism=False):
    # init
    t = 0
    ...
    best_individual_score = max(eval_curr_gen)
    best_individual_vector = None
    ...
    while calls < max_calls_to_target_functions:
        ...
        if candidate_score > best_individual_score:
            ...
            best_individual_vector = curr_generation[curr_best_index]
